...
namespace Servicio.Datos
{
    ...
    public partial class posiciones
    {
        ...
        public posiciones()
        {
            ...
            this.posicionesPersonas1 = new HashSet<posicionesPersonas>();
            this.posicionesPersonas2 = new HashSet<posicionesPersonas>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<posicionesPersonas> posicionesPersonas1 { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<posicionesPersonas> posicionesPersonas2 { get; set; }
    }
}
